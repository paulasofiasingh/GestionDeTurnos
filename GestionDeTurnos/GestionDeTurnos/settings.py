"""
Django settings for GestionDeTurnos project.
...
SECRET_KEY = 'django-insecure-$gc^p9ctemy1-!txnu055hjtrhijqchx%b-4iw6va4qxx-zr9g'
...
ROOT_URLCONF = 'GestionDeTurnos.urls'
...
WSGI_APPLICATION = 'GestionDeTurnos.wsgi.application'
